...
class Base():
    ...
    def wait_and_click_element(self, locator):
        """метод для ожидание элемента на странице пока он станет кликабельным и кликает на жлемент"""
    ...
    def make_screenshoot(self, location=None):
        ...
        self.driver.save_screenshot(
            f'/home/abalashov/selenium_course/exist_magazine/tests/screens/screen_{location}_{screen_time}.png')
